...
CreateThread(function()
	...
	for i=1, 110, 1 do
		if QBCore.Shared.Items["chair"..i] then	QBCore.Functions.CreateUseableItem("chair"..i, function(source, item) TriggerClientEvent('jim-chairs:Use', source, i) end) end
	end
end)
